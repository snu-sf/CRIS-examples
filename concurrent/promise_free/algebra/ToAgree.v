...
Proof.
  ...
  intros _ _ [<-%to_agreeM_agree|INCL%to_agreeM_included]%Some_included_1.
...
Proof.
  ...
  destruct INCL0 as [m0' Eq0]. destruct INCL as [? Eq'].
  apply local_update_unital_discrete => z Valid Eq. split; [done|].
  rewrite Eq Eq0. rewrite -cmra_assoc (cmra_comm m0' z) cmra_assoc -Eq.
