...
Module MapI. Section MapI.
  ...
  Definition fnsems : fnsemmap :=
    {[fid MapHdr.init # (msk_scp scopes msk_true, (None, cfunU MapHdr.init init));
      fid MapHdr.get  # (msk_scp scopes msk_true, (None, cfunU MapHdr.get get));
      fid MapHdr.set  # (msk_scp scopes msk_true, (None, cfunU MapHdr.set set));
      fid MapHdr.set_by_user # (msk_scp scopes msk_true, (None, cfunU MapHdr.set_by_user set_by_user))]}.
