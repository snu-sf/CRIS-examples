  ...
  ***)
  ...
  Definition fnsems : fnsemmap :=
    {[fid MapHdr.init # (msk_scp scopes msk_true, (fsp_some init_spec, fbody_trivial));
      fid MapHdr.get  # (msk_scp scopes msk_true, (fsp_some get_spec, cfunN MapHdr.get get));
      fid MapHdr.set  # (msk_scp scopes msk_true, (fsp_some set_spec, cfunN MapHdr.set set));
      fid MapHdr.set_by_user # (msk_scp scopes msk_true, (fsp_some set_by_user_spec, cfunN MapHdr.set_by_user set_by_user))]}.
