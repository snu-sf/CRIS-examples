...
Section definitions.
  ...
  Context `{!crisG Γ Σ α β τ _S _I, _CONC: !concGS, _MEM: !memGS, !stackG jobID retID, _SCH: !schGS}.
  Context (N : namespace).
...
Module StackM. Section StackM.
  ...
  Context `{!crisG Γ Σ α β τ _S _I, _CONC: !concGS, _SCH: !schGS, _MEM: !memGS, !stackG jobID retID}.
